...
import { LISTENING_LESSON_SEEDS } from './listening-lessons';

export const CURRICULUM_VERSION = '2026.08.150.listening-1';
...
export const ALL_LISTENING_LESSON_SEEDS = [...LISTENING_LESSON_SEEDS];
...
export const CURRICULUM_CATALOG_STATS = {
  ...
  listeningLessons: ALL_LISTENING_LESSON_SEEDS.length,
